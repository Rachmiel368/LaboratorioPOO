...
public class Actualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int SearchID = Integer.parseInt(request.getParameter("IDusuario"));
            ...
            int ID = Integer.parseInt(usr.getID());
            ...
            String consulta = "UPDATE usuario SET IDUsuario =" +ID+", FName ='" +usr.getFname()+"', LName ='"+usr.getLname()+"', color ='"+usr.getColor()+"' WHERE IDusuario= "+SearchID+";";
            ...
            out.println("</table>");
            out.println("<h1>El registro se ha actualizando con exito.</h1><br>"
